...
4. "list": "today" якщо задача явно на сьогодні (сказано "сьогодні", вказано час на сьогодні, або дедлайн сьогодні/прострочений), інакше "inbox".
5. "time": "HH:MM" якщо вказано конкретний час, інакше null.
6. "deadline": "YYYY-MM-DD" якщо згадано термін ("до пʼятниці", "завтра", "до 25-го") — обчисли реальну дату від сьогодні, інакше null.
